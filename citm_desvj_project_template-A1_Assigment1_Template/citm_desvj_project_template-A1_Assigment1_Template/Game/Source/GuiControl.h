...
public:
	...
	void NotifyObserver()
	{
		...
		case FunctionGUI::PLAY: break;
		case FunctionGUI::CONTINUE: break;
		case FunctionGUI::SETTINGS: break;
		case FunctionGUI::CREDITS: break;
		case FunctionGUI::RESUME: break;
		case FunctionGUI::BACKtoTITLE: break;
		case FunctionGUI::MUSIC: break;
